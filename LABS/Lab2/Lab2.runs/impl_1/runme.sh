...
HD_PWD='C:/Users/eeyaa63/Downloads/EEEE4123/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_cond.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source temp_cond.tcl -notrace
