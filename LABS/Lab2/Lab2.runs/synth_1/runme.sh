...
HD_PWD='C:/Users/eeyaa63/Documents/GitHub/EEEE4123/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log temp_cond.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source temp_cond.tcl
