...
synth_design -top pow_3 -part xc7a15tcpg236-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef pow_3.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file pow_3_utilization_synth.rpt -pb pow_3_utilization_synth.pb"
