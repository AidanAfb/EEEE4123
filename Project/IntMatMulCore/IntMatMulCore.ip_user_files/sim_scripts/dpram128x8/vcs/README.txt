...
#
# Generated by export_simulation on Sun Apr 26 19:01:28 +0100 2026
#
################################################################################
...
'-reset_run' switch to the './dpram128x8.sh' script.

./dpram128x8.sh -reset_run
...
./dpram128x8.sh -noclean_files

For more information on the script, please type './dpram128x8.sh -help'.
