...
#
# Generated by export_simulation on Sun Apr 26 19:14:24 +0100 2026
#
################################################################################
...
'-reset_run' switch to the './dpram64x32.sh' script.

./dpram64x32.sh -reset_run
...
./dpram64x32.sh -noclean_files

For more information on the script, please type './dpram64x32.sh -help'.
