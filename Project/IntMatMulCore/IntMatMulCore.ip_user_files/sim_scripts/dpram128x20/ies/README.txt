...
#
# Generated by export_simulation on Sun Apr 26 19:10:47 +0100 2026
#
################################################################################
...
'-reset_run' switch to the './dpram128x20.sh' script.

./dpram128x20.sh -reset_run
...
./dpram128x20.sh -noclean_files

For more information on the script, please type './dpram128x20.sh -help'.
